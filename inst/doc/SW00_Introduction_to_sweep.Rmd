...
A significant benefit is that the resulting `ts` object maintains a "timekit index", which will help with forecasting dates later. We can verify this using `has_timekit_idx()` from the `timekit` package.
