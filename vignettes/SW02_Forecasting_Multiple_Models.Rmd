...
Next, we map `sw_sweep`, which coerces the forecast into the "tidy" tibble format. We set `fitted = FALSE` to remove the model fitted values from the output. We set `timekit_idx = TRUE` to use dates instead of numeric values for the index.
